...
func newCasbinRule(db *gorm.DB, opts ...gen.DOOption) casbinRule {
	...
	_casbinRule.CreatedAt = field.NewInt64(tableName, "created_at")
	_casbinRule.UpdatedAt = field.NewInt64(tableName, "updated_at")
...
type casbinRule struct {
	...
	ALL       field.Asterisk
	ID        field.Int64
	Ptype     field.String // Policy type: p(policy), g(user role)
	V0        field.String // User ID/Role
	V1        field.String // Resource domain
	V2        field.String // Resource type
	V3        field.String // Action
	V4        field.String // Effect
	V5        field.String // Extension field
