...
func newRole(db *gorm.DB, opts ...gen.DOOption) role {
	...
	_role.RoleDomain = field.NewString(tableName, "role_domain")
	_role.SuperAdmin = field.NewInt32(tableName, "super_admin")
	_role.SpaceRoleType = field.NewInt32(tableName, "space_role_type")
	_role.IsBuiltin = field.NewInt32(tableName, "is_builtin")
	_role.IsDisabled = field.NewInt32(tableName, "is_disabled")
...
type role struct {
	...
	RoleCode      field.String // Role code
	RoleName      field.String // Role name
	RoleDomain    field.String // Permission domain: global-Global permissions, space-Space permissions
	SuperAdmin    field.Int32  // Is super admin: 0-No, 1-Yes
	SpaceRoleType field.Int32  // Space role type: 1-owner, 2-admin, 3-member (only valid when role_domain=space)
	IsBuiltin     field.Int32  // Is builtin role: 0-No, 1-Yes
	IsDisabled    field.Int32  // Is disabled: 0-Enabled, 1-Disabled
	Permissions   field.String // Permission matrix JSON configuration
...
func (r *role) updateTableName(table string) *role {
	...
	r.RoleDomain = field.NewString(table, "role_domain")
	r.SuperAdmin = field.NewInt32(table, "super_admin")
	r.SpaceRoleType = field.NewInt32(table, "space_role_type")
	r.IsBuiltin = field.NewInt32(table, "is_builtin")
	r.IsDisabled = field.NewInt32(table, "is_disabled")
...
func (r *role) fillFieldMap() {
	...
	r.fieldMap["role_domain"] = r.RoleDomain
	r.fieldMap["super_admin"] = r.SuperAdmin
	r.fieldMap["space_role_type"] = r.SpaceRoleType
	r.fieldMap["is_builtin"] = r.IsBuiltin
	r.fieldMap["is_disabled"] = r.IsDisabled
