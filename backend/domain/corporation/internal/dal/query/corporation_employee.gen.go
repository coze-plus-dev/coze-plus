...
func newCorporationEmployee(db *gorm.DB, opts ...gen.DOOption) corporationEmployee {
	...
	_corporationEmployee.CorpID = field.NewInt64(tableName, "corp_id")
	...
	_corporationEmployee.DeletedAt = field.NewInt64(tableName, "deleted_at")
...
type corporationEmployee struct {
	corporationEmployeeDo corporationEmployeeDo
...
func (c *corporationEmployee) WithContext(ctx context.Context) *corporationEmployeeDo {
	return c.corporationEmployeeDo.WithContext(ctx)
}

func (c corporationEmployee) TableName() string { return c.corporationEmployeeDo.TableName() }

func (c corporationEmployee) Alias() string { return c.corporationEmployeeDo.Alias() }

func (c corporationEmployee) Columns(cols ...field.Expr) gen.Columns {
	return c.corporationEmployeeDo.Columns(cols...)
}
...
func (c corporationEmployeeDo) Debug() *corporationEmployeeDo {
	return c.withDO(c.DO.Debug())
}

func (c corporationEmployeeDo) WithContext(ctx context.Context) *corporationEmployeeDo {
	return c.withDO(c.DO.WithContext(ctx))
}

func (c corporationEmployeeDo) ReadDB() *corporationEmployeeDo {
	return c.Clauses(dbresolver.Read)
}

func (c corporationEmployeeDo) WriteDB() *corporationEmployeeDo {
	return c.Clauses(dbresolver.Write)
}

func (c corporationEmployeeDo) Session(config *gorm.Session) *corporationEmployeeDo {
	return c.withDO(c.DO.Session(config))
}

func (c corporationEmployeeDo) Clauses(conds ...clause.Expression) *corporationEmployeeDo {
	return c.withDO(c.DO.Clauses(conds...))
}

func (c corporationEmployeeDo) Returning(value interface{}, columns ...string) *corporationEmployeeDo {
	return c.withDO(c.DO.Returning(value, columns...))
}

func (c corporationEmployeeDo) Not(conds ...gen.Condition) *corporationEmployeeDo {
	return c.withDO(c.DO.Not(conds...))
}

func (c corporationEmployeeDo) Or(conds ...gen.Condition) *corporationEmployeeDo {
	return c.withDO(c.DO.Or(conds...))
}

func (c corporationEmployeeDo) Select(conds ...field.Expr) *corporationEmployeeDo {
	return c.withDO(c.DO.Select(conds...))
}

func (c corporationEmployeeDo) Where(conds ...gen.Condition) *corporationEmployeeDo {
	return c.withDO(c.DO.Where(conds...))
}

func (c corporationEmployeeDo) Order(conds ...field.Expr) *corporationEmployeeDo {
	return c.withDO(c.DO.Order(conds...))
}

func (c corporationEmployeeDo) Distinct(cols ...field.Expr) *corporationEmployeeDo {
	return c.withDO(c.DO.Distinct(cols...))
}

func (c corporationEmployeeDo) Omit(cols ...field.Expr) *corporationEmployeeDo {
	return c.withDO(c.DO.Omit(cols...))
}

func (c corporationEmployeeDo) Join(table schema.Tabler, on ...field.Expr) *corporationEmployeeDo {
	return c.withDO(c.DO.Join(table, on...))
}

func (c corporationEmployeeDo) LeftJoin(table schema.Tabler, on ...field.Expr) *corporationEmployeeDo {
	return c.withDO(c.DO.LeftJoin(table, on...))
}

func (c corporationEmployeeDo) RightJoin(table schema.Tabler, on ...field.Expr) *corporationEmployeeDo {
	return c.withDO(c.DO.RightJoin(table, on...))
}

func (c corporationEmployeeDo) Group(cols ...field.Expr) *corporationEmployeeDo {
	return c.withDO(c.DO.Group(cols...))
}

func (c corporationEmployeeDo) Having(conds ...gen.Condition) *corporationEmployeeDo {
	return c.withDO(c.DO.Having(conds...))
}

func (c corporationEmployeeDo) Limit(limit int) *corporationEmployeeDo {
	return c.withDO(c.DO.Limit(limit))
}

func (c corporationEmployeeDo) Offset(offset int) *corporationEmployeeDo {
	return c.withDO(c.DO.Offset(offset))
}

func (c corporationEmployeeDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *corporationEmployeeDo {
	return c.withDO(c.DO.Scopes(funcs...))
}

func (c corporationEmployeeDo) Unscoped() *corporationEmployeeDo {
...
func (c corporationEmployeeDo) Attrs(attrs ...field.AssignExpr) *corporationEmployeeDo {
	return c.withDO(c.DO.Attrs(attrs...))
}

func (c corporationEmployeeDo) Assign(attrs ...field.AssignExpr) *corporationEmployeeDo {
	return c.withDO(c.DO.Assign(attrs...))
}

func (c corporationEmployeeDo) Joins(fields ...field.RelationField) *corporationEmployeeDo {
...
func (c corporationEmployeeDo) Preload(fields ...field.RelationField) *corporationEmployeeDo {
	for _, _f := range fields {
