...
func newCorporationEmployeeDepartment(db *gorm.DB, opts ...gen.DOOption) corporationEmployeeDepartment {
	...
	_corporationEmployeeDepartment.DeletedAt = field.NewInt64(tableName, "deleted_at")
...
type corporationEmployeeDepartment struct {
	corporationEmployeeDepartmentDo corporationEmployeeDepartmentDo
...
func (c *corporationEmployeeDepartment) WithContext(ctx context.Context) *corporationEmployeeDepartmentDo {
	return c.corporationEmployeeDepartmentDo.WithContext(ctx)
}

func (c corporationEmployeeDepartment) TableName() string {
	return c.corporationEmployeeDepartmentDo.TableName()
}

func (c corporationEmployeeDepartment) Alias() string {
	return c.corporationEmployeeDepartmentDo.Alias()
}

func (c corporationEmployeeDepartment) Columns(cols ...field.Expr) gen.Columns {
	return c.corporationEmployeeDepartmentDo.Columns(cols...)
}
...
func (c corporationEmployeeDepartmentDo) Debug() *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Debug())
}

func (c corporationEmployeeDepartmentDo) WithContext(ctx context.Context) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.WithContext(ctx))
}

func (c corporationEmployeeDepartmentDo) ReadDB() *corporationEmployeeDepartmentDo {
	return c.Clauses(dbresolver.Read)
}

func (c corporationEmployeeDepartmentDo) WriteDB() *corporationEmployeeDepartmentDo {
	return c.Clauses(dbresolver.Write)
}

func (c corporationEmployeeDepartmentDo) Session(config *gorm.Session) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Session(config))
}

func (c corporationEmployeeDepartmentDo) Clauses(conds ...clause.Expression) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Clauses(conds...))
}

func (c corporationEmployeeDepartmentDo) Returning(value interface{}, columns ...string) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Returning(value, columns...))
}

func (c corporationEmployeeDepartmentDo) Not(conds ...gen.Condition) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Not(conds...))
}

func (c corporationEmployeeDepartmentDo) Or(conds ...gen.Condition) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Or(conds...))
}

func (c corporationEmployeeDepartmentDo) Select(conds ...field.Expr) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Select(conds...))
}

func (c corporationEmployeeDepartmentDo) Where(conds ...gen.Condition) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Where(conds...))
}

func (c corporationEmployeeDepartmentDo) Order(conds ...field.Expr) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Order(conds...))
}

func (c corporationEmployeeDepartmentDo) Distinct(cols ...field.Expr) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Distinct(cols...))
}

func (c corporationEmployeeDepartmentDo) Omit(cols ...field.Expr) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Omit(cols...))
}

func (c corporationEmployeeDepartmentDo) Join(table schema.Tabler, on ...field.Expr) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Join(table, on...))
}

func (c corporationEmployeeDepartmentDo) LeftJoin(table schema.Tabler, on ...field.Expr) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.LeftJoin(table, on...))
}

func (c corporationEmployeeDepartmentDo) RightJoin(table schema.Tabler, on ...field.Expr) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.RightJoin(table, on...))
}

func (c corporationEmployeeDepartmentDo) Group(cols ...field.Expr) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Group(cols...))
}

func (c corporationEmployeeDepartmentDo) Having(conds ...gen.Condition) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Having(conds...))
}

func (c corporationEmployeeDepartmentDo) Limit(limit int) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Limit(limit))
}

func (c corporationEmployeeDepartmentDo) Offset(offset int) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Offset(offset))
}

func (c corporationEmployeeDepartmentDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Scopes(funcs...))
}

func (c corporationEmployeeDepartmentDo) Unscoped() *corporationEmployeeDepartmentDo {
...
func (c corporationEmployeeDepartmentDo) Attrs(attrs ...field.AssignExpr) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Attrs(attrs...))
}

func (c corporationEmployeeDepartmentDo) Assign(attrs ...field.AssignExpr) *corporationEmployeeDepartmentDo {
	return c.withDO(c.DO.Assign(attrs...))
}

func (c corporationEmployeeDepartmentDo) Joins(fields ...field.RelationField) *corporationEmployeeDepartmentDo {
...
func (c corporationEmployeeDepartmentDo) Preload(fields ...field.RelationField) *corporationEmployeeDepartmentDo {
	for _, _f := range fields {
