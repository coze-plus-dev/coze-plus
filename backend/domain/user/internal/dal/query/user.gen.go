...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.IsDisabled = field.NewInt32(tableName, "is_disabled")
	...
	_user.DeletedBy = field.NewInt64(tableName, "deleted_by")
...
type user struct {
	...
	IsDisabled   field.Int32  // User status: 0-enabled, 1-disabled
	Locale       field.String // Locale
	CreatedBy    field.Int64  // Creator user ID
	...
	DeletedBy    field.Int64  // Deleter user ID
...
func (u *user) updateTableName(table string) *user {
	...
	u.DeletedBy = field.NewInt64(table, "deleted_by")
