...
type User struct {
	...
	IsDisabled   int32          `gorm:"column:is_disabled;not null;comment:User status: 0-enabled, 1-disabled" json:"is_disabled"`              // User status: 0-enabled, 1-disabled
	Locale       string         `gorm:"column:locale;not null;comment:Locale" json:"locale"`                                                    // Locale
	CreatedBy    int64          `gorm:"column:created_by;comment:Creator user ID" json:"created_by"`                                            // Creator user ID
	...
	DeletedBy    int64          `gorm:"column:deleted_by;comment:Deleter user ID" json:"deleted_by"`                                            // Deleter user ID
}
