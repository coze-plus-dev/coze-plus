...
type CorporationServiceClient struct {
	*corporation.CorporationServiceClient
}
...
func NewCorporationServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *CorporationServiceClient {
	return &CorporationServiceClient{
		CorporationServiceClient: corporation.NewCorporationServiceClientFactory(t, f),
	}
}
...
func NewCorporationServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *CorporationServiceClient {
	return &CorporationServiceClient{
		CorporationServiceClient: corporation.NewCorporationServiceClientProtocol(t, iprot, oprot),
	}
}

func NewCorporationServiceClient(c thrift.TClient) *CorporationServiceClient {
	return &CorporationServiceClient{
		CorporationServiceClient: corporation.NewCorporationServiceClient(c),
	}
}
...
func NewDepartmentServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *DepartmentServiceClient {
	return &DepartmentServiceClient{
		DepartmentServiceClient: department.NewDepartmentServiceClientFactory(t, f),
	}
}
...
func NewDepartmentServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *DepartmentServiceClient {
	return &DepartmentServiceClient{
		DepartmentServiceClient: department.NewDepartmentServiceClientProtocol(t, iprot, oprot),
	}
}

func NewDepartmentServiceClient(c thrift.TClient) *DepartmentServiceClient {
	return &DepartmentServiceClient{
		DepartmentServiceClient: department.NewDepartmentServiceClient(c),
	}
}
...
func NewEmployeeServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *EmployeeServiceClient {
	return &EmployeeServiceClient{
		EmployeeServiceClient: employee.NewEmployeeServiceClientFactory(t, f),
	}
}
...
func NewEmployeeServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *EmployeeServiceClient {
	return &EmployeeServiceClient{
		EmployeeServiceClient: employee.NewEmployeeServiceClientProtocol(t, iprot, oprot),
	}
}

func NewEmployeeServiceClient(c thrift.TClient) *EmployeeServiceClient {
	return &EmployeeServiceClient{
		EmployeeServiceClient: employee.NewEmployeeServiceClient(c),
	}
}
...
type CorporationServiceProcessor struct {
	*corporation.CorporationServiceProcessor
}

func NewCorporationServiceProcessor(handler CorporationService) *CorporationServiceProcessor {
	self := &CorporationServiceProcessor{corporation.NewCorporationServiceProcessor(handler)}
	return self
}

type DepartmentServiceProcessor struct {
	*department.DepartmentServiceProcessor
}

func NewDepartmentServiceProcessor(handler DepartmentService) *DepartmentServiceProcessor {
	self := &DepartmentServiceProcessor{department.NewDepartmentServiceProcessor(handler)}
	return self
}

type EmployeeServiceProcessor struct {
	*employee.EmployeeServiceProcessor
}
